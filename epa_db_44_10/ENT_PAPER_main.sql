...
DELETE FROM papers  WHERE paperid ='a44627';
DELETE FROM papers  WHERE paperid ='a4410ann';
DELETE FROM papers  WHERE paperid ='a4410as';
DELETE FROM papers  WHERE paperid ='a4410rev';
DELETE FROM papers  WHERE paperid ='a45282';
...
DELETE FROM authors WHERE paperid='a44627';
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Erik','Elldér','a44627','0', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Ana Gil','Solá','a44627','1', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Anders','Larsson','a44627','2', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;

DELETE FROM issues WHERE journal='A' AND volume='44' AND issue='10'; 

INSERT INTO issues (journal, volume, issue, issuetype, theme_start, theme_end, guesteds,heading,ptype14)
VALUES
('A','44','10','1','2298','2302','Publisher’s announcement','','Publisher’s announcement:');

INSERT into papers (paperid,journal,year,volume,issue,start_page,end_page,ptype,title,abstract,open_access)
VALUES
('a4410as','A','2012','44','10',
'2298','2302','14',
'Winners of Ashby Prizes',
'There is no abstract for this paper','TRUE'
);

INSERT into papers (paperid,journal,year,volume,issue,start_page,end_page,ptype,title,abstract)
VALUES
('a4410rev','A','2012','44','10',
'2530','2532','3',
'Reviews',
'
<br>
Johnston on Sampson: <i>Great American city: Chicago and the enduring neighbourhood effect</i>');
...
DELETE FROM authors WHERE paperid='a45282';
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Anssi','Paasi','a45282','1', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
/*--*/
