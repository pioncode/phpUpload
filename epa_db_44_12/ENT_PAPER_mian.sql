...
DELETE FROM papers  WHERE paperid ='a45439';
DELETE FROM papers  WHERE paperid ='a45612';
DELETE FROM papers  WHERE paperid ='a43028';


/*
Added
*/
DELETE FROM issues WHERE journal='A' AND volume='44' AND issue='12'; 


INSERT INTO issues (journal, volume, issue, issuetype, theme_start, theme_end, heading,guesteds,ptype14)
VALUES
('A','44','12','1','2794','2882','Theme issue: Interrogating unequal rights to the Chinese city','Shenjing He, Guo Chen','');
...
DELETE FROM authors WHERE paperid ='a45439';

INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Maarten','van Ham','a45439','0', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('David','Manley','a45439','1', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
...
DELETE FROM authors WHERE paperid ='a45612';

INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Shenjing','He','a45612','0', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Guo','Chen','a45612','1', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
