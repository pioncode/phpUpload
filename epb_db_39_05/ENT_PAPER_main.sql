...
DELETE FROM papers  WHERE paperid ='b3905rev';
DELETE FROM papers  WHERE paperid ='b3905ann';
DELETE FROM papers  WHERE paperid ='b3905br';
...
DELETE FROM issues WHERE journal='B' AND volume='39' AND issue='5'; 
/*
INSERT INTO issues (journal, volume, issue, issuetype, theme_start, theme_end, guesteds,heading,ptype14)
VALUES
('B','39','5','1','781','781','Publisher’s announcement','','Publisher’s announcement');
*/

INSERT into papers (paperid,journal,year,volume,issue,start_page,end_page,ptype,title,abstract,open_access)
VALUES
('b3905ann','B','2012','39','5',
'781','781','0',
'<font color=''black''>   Publisher’s announcement</font>',
'There is no abstract for this paper','TRUE'
);

INSERT into papers (paperid,journal,year,volume,issue,start_page,end_page,ptype,title,abstract)
VALUES
('b3905rev','B','2012','39','5',
'965','970','3',
'Reviews',
'
<br>
Longley on Foth, Forlano, Satchell, Gibbs (Eds):<br>
<i>From social butterfly to engaged citizen: urban informatics, social media, ubiquitous computing, and mobile
technology to support citizen engagement</i>
<br>
Reiss on Glaeser:<br>
<i>Triumph of the city: how our greatest invention makes us richer, smarter, greener, healthier, and happier</i>
<br>
Gordon on Wallin, Horelli, Saad-Sulonen (Eds):<br>
<i>Digital tools in participatory planning</i>
<br>
Tulloch on Nedovic-Budic, Crompvoets, Georgiadou (Eds):<br>
<i>Spatial data infrastructures in context: north and south</i>'
);
...
VALUES
(nextval('misc_seq'),'b36151_appendix.pdf','Appendix','0','b36151');
INSERT into papers (paperid,journal,year,volume,issue,start_page,end_page,ptype,title,abstract)
VALUES
('b37088','B','2012','39','5',
'820','837','0',
