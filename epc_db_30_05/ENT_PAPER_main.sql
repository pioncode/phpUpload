DELETE FROM papers  WHERE paperid ='c3005ed';
DELETE FROM papers  WHERE paperid ='c3005rev';
...
DELETE FROM issues WHERE journal='C' AND volume='30' AND issue='5'; 

INSERT INTO issues (journal, volume, issue, issuetype, theme_start, theme_end, guesteds,heading,ptype14)
VALUES
('C','30','5','1','761','847','Claire Champenois, Sabine Menu','Theme issue: The implementation of the ''new'' cluster policies: a critical evaluation','Editors'' choice');

INSERT into papers (paperid,journal,year,volume,issue,start_page,end_page,ptype,title,abstract,open_access)
VALUES
('c3005ed','C','2012','30','5',
'761','765','1',
'''New'' cluster policies: a process-based approach',
'There is no abstract with this article',
'TRUE'
);

DELETE FROM authors WHERE paperid='c3005ed';
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Claire','Champenois','c3005ed','0', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Sabine','Menu','c3005ed','1', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;

INSERT into papers (paperid,journal,year,volume,issue,start_page,end_page,ptype,title,abstract)
VALUES
('c3005rev','C','2012','30','05',
'941','942','0',
'Review essay: The path towards corporate social responsibility',
'There is no abstract with this paper'
);

DELETE FROM authors WHERE paperid='c3005rev';
INSERT into authors 
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Judith L','Walls','c3005rev','0', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
...
(first_name,last_name,paperid, position, designator, recno, corresp_auth, footnote, email, affilnum)
VALUES
('Roberto','Ezcurra','c11234r','0', 'A', nextval('authors_recno_seq'), 'False',NULL,'','0')
;
/*--------*/
...
('c11113','C','2012','30','05',
'871','890','0',
'Dynamics of spatial interdependence: the contingent effect of international trade on voluntary environmental standards',
