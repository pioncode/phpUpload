...
DELETE FROM papers  WHERE paperid ='p4109mar';
DELETE FROM papers  WHERE paperid ='p7282';


DELETE FROM issues WHERE journal='P' AND volume='41' AND issue='09'; 
...
'David Marr',
'',
'For readers who would prefer to download a PDF of the whole issue');
...
'For readers who would prefer to download the whole issue rather than individual contributions to this special issue'
);
...
INSERT INTO misc (key,url,link_title,position,paperid)
VALUES
(nextval('misc_seq'),'p7308-f2.pdf','Figure 2','0','p7308');
INSERT INTO misc (key,url,link_title,position,paperid)
VALUES
